...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Cue.session'
        db.delete_column(u'show_cue', 'session_id')

        # Adding field 'Cue.stream'
        db.add_column(u'show_cue', 'stream',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['show.Stream'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Cue.session'
        db.add_column(u'show_cue', 'session',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['show.Stream'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Cue.stream'
        db.delete_column(u'show_cue', 'stream_id')
