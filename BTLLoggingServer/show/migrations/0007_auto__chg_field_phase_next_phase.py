...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Phase.next_phase'
        db.alter_column(u'show_phase', 'next_phase_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['show.Phase'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Phase.next_phase'
        raise RuntimeError("Cannot reverse this migration. 'Phase.next_phase' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Phase.next_phase'
        db.alter_column(u'show_phase', 'next_phase_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['show.Phase']))
    ...
    models = {
        ...
        u'show.phase': {
            ...
            'next_phase': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['show.Phase']", 'null': 'True', 'blank': 'True'}),
