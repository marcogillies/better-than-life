...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Phase.message'
        db.add_column(u'show_phase', 'message',
                      self.gf('django.db.models.fields.CharField')(default='hello', max_length=400),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Phase.message'
        db.delete_column(u'show_phase', 'message')
