...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Stream'
        db.create_table(u'show_stream', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('SEID', self.gf('django.db.models.fields.IntegerField')()),
            ('type', self.gf('django.db.models.fields.CharField')(max_length=20)),
        ))
        db.send_create_signal(u'show', ['Stream'])


        # Changing field 'Cue.session'
        db.alter_column(u'show_cue', 'session_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['show.Stream'], null=True))
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'show_stream')


        # Changing field 'Cue.session'
        db.alter_column(u'show_cue', 'session_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['show.Session'], null=True))
    ...
    models = {
        ...
        u'show.cue': {
            ...
            'session': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['show.Stream']", 'null': 'True', 'blank': 'True'})
        },
        u'show.logitem': {
